  ...
  return (
    <div className="flex bg-white rounded-lg text-black flex-col text-center  justify-center items-center gap-4 p-4 w-full">
        <Image src={logoMastercraft} className="relative top-[-30px]" alt={""}></Image>
          ...
          <p className="px-8 rounded-3xl text-white bg-[hsl(176,50%,47%)] items-center text-center flex sm:w-[40%] w-[full] ">Back this project</p>
          <div className="flex rounded-3xl sm:bg-[hsl(0,0%,80%)]  sm:w-[40%] sm:justify-between items-center bg-transparent justify-center ">
